...
for file in files:
        if file not in ll:
                ...
                for i, l in tqdm(df.iterrows()):
                        print(l[1].values)
                        exit()
                        position.append(distort(l[2]-5,l[1]-5)+ distort(l[2]-5,l[1]+l[3]+5) + distort(l[2]+l[3]+5,l[1]+l[3]+5)+ distort(l[2]+l[3]+5,l[1]-5))
                        image = plt.imread('./dataset/fish_hand/'+'/'+l[0])
                        save_fig(image,[distort(l[1]-5,l[0]-5)[0],distort(l[1]-5,l[0]-5)[1],distort(l[1]+l[2]+5,l[0]+l[2]+5)[0], distort(l[2]+l[3]+5,l[1]+l[3]+5)[1]],l[0])
